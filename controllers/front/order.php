...
class PostFinanceCheckoutOrderModuleFrontController extends PostFinanceCheckout_FrontPaymentController
{
    public $ssl = true;
    ...
    public function postProcess()
    {
        ...
        $orderState = PostFinanceCheckout_OrderStatus::getRedirectOrderStatus();
        try {
